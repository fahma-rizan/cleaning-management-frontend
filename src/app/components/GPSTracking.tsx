...
import { ArrowLeft, MapPin, Navigation, CheckCircle, Clock, X } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-purple-50 to-white dark:from-gray-900 dark:to-gray-800">
      <div className="container mx-auto px-4 py-8">
        ...
        {/* Map Modal - Shows when task is selected */}
        {selectedTask && (
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden">
              ...
              <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 className="text-xl font-bold text-gray-900 dark:text-white">GPS Navigation</h2>
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                      {activeTasks.find(t => t.id === selectedTask)?.customer} - {activeTasks.find(t => t.id === selectedTask)?.service}
                    </p>
                  </div>
                </div>
                <button
              ...
              {/* Map Content */}
              <div className="p-6">
                <div className="bg-gradient-to-br from-purple-100 to-blue-100 dark:from-purple-900 dark:to-blue-900 rounded-lg h-[500px] flex items-center justify-center relative overflow-hidden">
                  ...
                  <div className="relative z-10 text-center">
                    ...
                    <p className="text-gray-600 dark:text-gray-300 mb-4">
                      Interactive map showing route to service location
                    </p>
                    <div className="bg-white dark:bg-gray-800 rounded-lg p-4 max-w-md mx-auto mb-4">
                      <div className="flex items-start gap-2">
                        <MapPin className="w-5 h-5 text-green-600 mt-0.5" />
                        <div className="text-left">
                          <p className="font-semibold text-gray-900 dark:text-white">Destination</p>
                          <p className="text-sm text-gray-600 dark:text-gray-400">
                            {activeTasks.find(t => t.id === selectedTask)?.address}
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                <div className="mt-6 flex gap-3">
                  ...
                  <button
                    onClick={() => setSelectedTask(null)}
                    className="px-6 bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-white py-3 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors font-medium"
                  >
                    Close
                  </button>
                </div>
