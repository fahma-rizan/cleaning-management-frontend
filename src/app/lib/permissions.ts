...
export const TAB_PERMISSIONS: Record<string, AdminRole[]> = {
  ...
  'availability-requests': ['Super Admin', 'Main Admin', 'Operations Manager'],
  'task-decline-requests': ['Super Admin', 'Main Admin', 'Operations Manager'],
  'staff-task-overview':   ['Super Admin', 'Main Admin', 'Operations Manager'],
