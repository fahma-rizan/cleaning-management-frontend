            ...
            return (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div
                    className={`mt-4 ${role.color} ${role.hoverColor} text-white text-center py-2 rounded-lg transition-colors`}
                  >
                    Register
                  </div>
                </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg max-w-2xl mx-auto">
          ...
          <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-300">
            <li className="flex items-start gap-2">
              ...
              <span>
                <strong>Customers</strong> can book and manage cleaning services
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-green-500 mt-0.5">●</span>
              <span>
                <strong>Staff</strong> need to provide profile photo and require
                admin approval
              </span>
            </li>
            <li className="flex items-start gap-2">
              ...
              <span>
                <strong>Admin</strong> registration requires a special access
                code from management
              </span>
            </li>
          </ul>
        </div>
