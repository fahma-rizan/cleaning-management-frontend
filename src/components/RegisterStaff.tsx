  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-purple-100 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center p-4">
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl w-full max-w-2xl p-8 my-8">
        ...
        <h1 className="text-3xl font-black text-center mb-2 dark:text-white tracking-tight">
          Staff Registration
        </h1>
        <p className="text-gray-600 dark:text-gray-300 text-center mb-8 tracking-wide">
          Join Cloud Laundry professional cleaning team
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-4">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                <label className="block text-xs font-bold mb-2 text-gray-700 dark:text-gray-300 uppercase">
                  First Name *
                </label>
