...
const GoogleIcon = () => (
  ...
  >
    ...
    />
    <path
      d="M3.96409 10.71C3.78409 10.17 3.68182 9.59318 3.68182 9C3.68182 8.40682 3.78409 7.82955 3.96409 7.28955V4.95819H0.957275C0.347727 6.17318 0 7.54773 0 9C0 10.4523 0.347727 11.8268 0.957275 13.0418L3.96409 10.71Z"
      fill="#FBBC05"
    />
    <path
      d="M9 3.57955C10.3214 3.57955 11.5077 4.03364 12.4405 4.92545L15.0218 2.34409C13.4632 0.891818 11.4259 0 9 0C5.48182 0 2.43818 2.01682 0.957275 4.95818L3.96409 7.28955C4.67182 5.16273 6.65591 3.57955 9 3.57955Z"
      fill="#EA4335"
    />
  </svg>
);
...
export default function RefinedLogin({
  ...
  return (
    <div className="min-h-screen bg-[#F5F3FF] flex flex-col items-center justify-center p-6">
      ...
      <AuthCard className="relative">
        ...
        <div className="relative my-8">
          ...
          <div className="relative flex justify-center text-xs uppercase">
            <span className="px-4 bg-white text-[#9CA3AF] font-bold tracking-widest">
              OR
            </span>
          </div>
        </div>
      ...
      <div className="w-full max-w-[420px] mt-8 bg-white/50 backdrop-blur-sm border border-purple-100 rounded-2xl p-6 shadow-sm">
        <h3 className="text-xs font-bold text-[#7C3AED] uppercase tracking-widest mb-4 flex items-center gap-2">
        ...
        <div className="grid grid-cols-1 gap-4">
          <div className="flex flex-col gap-1">
            ...
            <div className="flex justify-between items-center text-sm">
              <code className="text-[#111827] bg-purple-50 px-2 py-0.5 rounded">
                any@email.com
              </code>
              <code className="text-[#7C3AED] font-bold">password123</code>
            </div>
          </div>
          <div className="flex flex-col gap-1 border-t border-purple-50 pt-3">
            <span className="text-[10px] font-black text-gray-400 uppercase">
              Staff Access
            </span>
            <div className="flex justify-between items-center text-sm">
              <code className="text-[#111827] bg-purple-50 px-2 py-0.5 rounded">
                staff@cloudlaundry.lk
              </code>
              <code className="text-[#7C3AED] font-bold">staff123</code>
            </div>
          </div>
          <div className="flex flex-col gap-1 border-t border-purple-50 pt-3">
            <span className="text-[10px] font-black text-gray-400 uppercase">
            ...
            <div className="flex justify-between items-center text-sm">
              <code className="text-[#111827] bg-purple-50 px-2 py-0.5 rounded">
                admin@cloudlaundry.lk
              </code>
              <code className="text-[#7C3AED] font-bold">admin123</code>
            </div>
          </div>
        </div>
      </div>
