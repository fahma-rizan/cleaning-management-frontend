...
export default function RefinedRegister() {
  ...
  const handleGoogleSignUp = () => {
    // Google OAuth sign up simulation
    setIsLoading(true);
    setTimeout(() => {
      setIsLoading(false);
      // In production, this would redirect to Google OAuth
      // For demo, simulate Google providing user data
      const googleUser = {
        firstName: 'John',
        lastName: 'Doe',
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="flex items-center gap-2 py-1">
            ...
            >
              {formData.agree ? <CheckSquare size={20} fill="currentColor" className="text-white" /> : <Square size={20} />}
            </button>
