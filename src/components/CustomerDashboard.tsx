...
export default function CustomerDashboard({ user, onLogout, theme, onToggleTheme }: CustomerDashboardProps) {
  ...
  const [bookingTab, setBookingTab] = useState<'ongoing' | 'upcoming' | 'past'>('ongoing');
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-100 dark:border-gray-700 shadow-sm">
              ...
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 dark:text-white">Ongoing Activity</h3>
                  <div className="flex items-center gap-2 px-3 py-1 bg-green-50 dark:bg-green-900/20 rounded-full">
                    <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></div>
                    <span className="text-xs font-bold text-green-700 dark:text-green-400">1 Active</span>
                  </div>
                </div>
                <button 
                  onClick={goToOngoing}
              ...
              <div className="mb-6 p-4 bg-purple-50 dark:bg-purple-900/10 rounded-xl">
                <div className="flex items-start justify-between mb-3">
                  <div>
                    <h4 className="font-bold text-gray-900 dark:text-white mb-1">Home Cleaning - Regular Cleaning</h4>
                    <p className="text-xs text-gray-500 dark:text-gray-400 font-medium">Booking ID: BK-1001</p>
                  </div>
                  <div className="text-right">
                    <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">ETA</p>
                    <p className="text-lg font-bold text-purple-600 dark:text-purple-400">12:30 PM</p>
                  </div>
                </div>
                <div className="flex items-center gap-2 pt-3 border-t border-purple-100 dark:border-purple-800">
                  ...
                  <div>
                    <p className="text-sm font-bold text-gray-900 dark:text-white">Maria Chen</p>
                    <p className="text-xs text-gray-500 dark:text-gray-400">Service Professional</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-6">
                <div className="flex items-center justify-between relative">
                  ...
                  <div className="absolute top-4 left-0 h-0.5 bg-purple-600" style={{ width: '66%' }}></div>
                  
                  {/* Steps */}
                  {['En Route', 'Started', 'In Progress', 'Completed'].map((step, idx) => {
                    ...
                    return (
                      <div key={step} className="flex flex-col items-center relative z-10 flex-1">
                        <div className={`w-8 h-8 rounded-full flex items-center justify-center border-2 mb-2 transition-all ${
                          ...
                          isCurrent ? 'bg-white dark:bg-gray-800 border-purple-600 ring-4 ring-purple-100 dark:ring-purple-900/30' :
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          {bookingTab === 'upcoming' && (
            upcomingBookings.length > 0 ? (
              <div className="space-y-6">
                <UpcomingBookingsList bookings={upcomingBookings} onReschedule={handleReschedule} onCancel={handleCancel} />
              </div>
            ) : (
              <div className="bg-white dark:bg-gray-800 rounded-xl p-12 text-center border border-gray-100 dark:border-gray-700">
                ...
                <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">No Upcoming Bookings</h3>
                <p className="text-gray-500 dark:text-gray-400 mb-6">You don't have any upcoming bookings at the moment.</p>
                <Link
                  to="/services"
          ...
          {bookingTab === 'past' && (
            pastBookings.length > 0 ? (
                      ...
                      <div className="flex flex-wrap gap-3 pt-4 border-t border-gray-50 dark:border-gray-700">
                        ...
                        {booking.status === 'completed' && (
                          <Link
                            ...
                            className="flex items-center gap-2 px-4 py-2 border border-purple-200 text-purple-600 rounded-lg hover:bg-purple-50 font-bold text-sm transition-all"
                          >
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl p-12 text-center border border-gray-100 dark:border-gray-700">
                ...
                <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">No Past Bookings</h3>
                <p className="text-gray-500 dark:text-gray-400">Your completed and cancelled bookings will appear here.</p>
              </div>
            )
          )}
        </div>
  ...
  const renderLoyalty = () => (
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-100 dark:border-gray-700">
        ...
        {loyaltySubTab === 'tiers' && <TiersPage currentTier={userData.currentTier} />}
        ...
        <div className="p-6 border-b border-white/5 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 flex items-center justify-center">
              <img src={imgLogo} alt="Cloud Laundry Logo" className="w-full h-full object-contain" />
            </div>
            <div>
