...
const OverviewTab = ({ account, onApplyDiscount }) => {
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          background: `${tier.color}12`, border: `2px solid ${tier.color}35`,
          display: 'flex', alignItems: 'center', justifyContent: 'center',
          fontSize: 36, boxShadow: `0 0 20px ${tier.color}20`,
        }}>
          {TIER_ICONS[tierName] || '🥉'}
        </div>
        ...
        <div style={{ flexShrink: 0, textAlign: 'right' }}>
          ...
          <div style={{ color: '#9CA3AF', fontSize: 11, marginTop: 3 }}>Earned all-time</div>
        </div>
      </div>
          ...
          {discountAvail ? (
            <>
              <div style={{ color: tier.color, fontWeight: 800, fontSize: 28, lineHeight: 1 }}>
                {discountPercent}%<span style={{ fontSize: 13, fontWeight: 600, marginLeft: 5, opacity: 0.7 }}>OFF</span>
              </div>
            ...
            <>
              ...
              <div style={{ color: '#9CA3AF', fontSize: 11.5, marginTop: 6 }}>{tierName} discount already applied</div>
            </>
          ) : (
            <>
              <div style={{ color: '#D1D5DB', fontWeight: 700, fontSize: 15 }}>Bronze</div>
              <div style={{ color: '#9CA3AF', fontSize: 11.5, marginTop: 6 }}>Reach Silver to unlock a discount</div>
            </>
          )}
        </div>
      </div>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12 }}>
          ...
          <div style={{ flex: 1 }}>
            <div style={{ fontWeight: 700, fontSize: 14, color: '#7C3AED', marginBottom: 6 }}>
              How to Redeem Your Points
            </div>
            <div style={{ fontSize: 13, color: '#6B7280', lineHeight: 1.65, marginBottom: 8 }}>
              Redeem points automatically at checkout when making a new booking.
              Select your payment method → enter points to redeem → instant discount applied.
            </div>
            <div style={{ fontSize: 12, color: '#9CA3AF', marginBottom: 14 }}>
              1 pt = Rs. 1 off &nbsp;·&nbsp; Minimum 100 pts required
            </div>
            <button
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 14 }}>
          ...
          <div>
            <div style={{ color: '#111827', fontWeight: 700, fontSize: 15 }}>Your {tierName} Benefits</div>
